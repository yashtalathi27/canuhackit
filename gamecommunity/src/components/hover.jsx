...
export default function DetailedCard({ imageUrl, name, details, type }) {
  return (
    <div className="absolute top-1/2 left-1/2 w-[30vw] h-auto p-4 bg-violet-950 text-white rounded-[15px] shadow-lg z-20 transform -translate-x-1/2 -translate-y-1/2">
